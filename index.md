...
1. Install the <b>[HF Patch for Koikatsu](https://github.com/ManlyMarco/KK-HF_Patch)</b>, or the <b>[HF Patch for Koikatsu Sunshine](https://github.com/ManlyMarco/KKS-HF_Patch)</b>.  
...
1. Install <b>[mmd_tools](https://extensions.blender.org/add-ons/mmd-tools/)</b> in Blender
...
1. If something doesn't look right and you don't see any errors in the log, check the <b>[Wiki Home on the sidebar](wiki)</b>.
