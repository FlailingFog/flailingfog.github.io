...
|---|---|---|---|---|---|
4.2.0|7.0.0|mmd_tools 4.2.2|HF Patch 3.28|HF Patch for KKS 1.17|--|
|3.6.9|6.6.3|mmd_tools 2.9.2|HF Patch 3.22|HF Patch for KKS 1.7|[Here](https://www.youtube.com/playlist?list=PLhiuav2SCuvc-wbexi2vwSnVHnZFwkYNP)|
